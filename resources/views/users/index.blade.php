...
<section class="home" id="home">
    ...
    <div class="home-slider owl-carousel">
        ...
        <div class="item">
            <img src="{{URL::asset('images/home_img1.jpg')}}" alt="">
            <div class="content">
        ...
        <div class="item">
            <img src="{{URL::asset('images/home_img2.jpg')}}" alt="">
            <div class="content">
        ...
        <div class="item">
            <img src="{{URL::asset('images/home_img3.jpg')}}" alt="">
            <div class="content">
        ...
        <div class="item">
            <img src="{{URL::asset('images/home_img4.jpg')}}" alt="">
            <div class="content">
...
<section class="arrival" id="arrival">
    ...
    <div class="box-container">
        ...
        <div class="box">
            <div class="image">
                <img src="{{URL::asset('images/arr-img1.png')}}" alt="">
            </div>
            <div class="info">
                <h3>smart tv</h3>
                <div class="subInfo">
        ...
        <div class="box">
            <div class="image">
                <img src="{{URL::asset('images/arr-img2.png')}}" alt="">
            </div>
            <div class="info">
                <h3>game console</h3>
                <div class="subInfo">
        ...
        <div class="box">
            <div class="image">
                <img src="{{URL::asset('images/arr-img3.png')}}" alt="">
            </div>
            <div class="info">
                <h3>latest shoes</h3>
                <div class="subInfo">
        ...
        <div class="box">
            <div class="image">
                <img src="{{URL::asset('images/arr-img4.png')}}" alt="">
            </div>
            <div class="info">
                <h3>smartphones</h3>
                <div class="subInfo">
        ...
        <div class="box">
            <div class="image">
                <img src="{{URL::asset('images/arr-img5.png')}}" alt="">
            </div>
            <div class="info">
        ...
        <div class="box">
            <div class="image">
                <img src="{{URL::asset('images/arr-img6.png')}}" alt="">
            </div>
            <div class="info">
...
<section class="feature" id="featured">
    ...
    <div class="row">
        ...
        <div class="image-container">
            ...
            <div class="big-image">
                <img src="{{URL::asset('images/watch1.png')}}" alt="">
            </div>

            <div class="small-image">
                <img class="image-active" src="{{URL::asset('images/watch1.png')}}" alt="">
                <img src="{{URL::asset('images/watch2.png')}}" alt="">
                <img src="{{URL::asset('images/watch3.png')}}" alt="">
                <img src="{{URL::asset('images/watch4.png')}}" alt="">
            </div>
